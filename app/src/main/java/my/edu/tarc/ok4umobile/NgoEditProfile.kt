...
class NgoEditProfile : Fragment() {
    private lateinit var binding: FragmentNgoEditProfileBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_ngo_edit_profile, container, false)
